...
public enum EnrolmentExceptionStatus {
    // contract
    NOT_FOUND_ENROLMENT(2000,HttpStatus.BAD_REQUEST, "존재하지 않는 계약입니다."),
    ...
    FAILED_ENROLMENT_SAVE(2004, HttpStatus.BAD_REQUEST, "예기치 못한 오류로 보험 계약에 실패하였습니다. 계약을 다시 시도해주세요.");
